...
const DataC = () => {
  ...
  const translations = {
    ar: {
      ...
      title:  `بيانات دقيقة لقرارات توسع أذكى`,
      description:
      ` الوحة التحكم ليست مجرد أرقام، بل هي رؤية حقيقية لنشاطك التجاري. تتبع صافي أرباحك، سلوك الزوار، وأداء المنتجات بدقة، لتعرف أين تضخ ميزانيتك الإعلانية وتحقق أعلى عائد  `,
      cta: "ابدأ متجرك الآن",
      demo: "شاهد النماذج",
      stats1: "مشروع منجز",
      stats2: "دول مختلفة",
  ...
  return (
    <section className="relative flex items-center overflow-hidden py-8 md:py-12 lg:py-16 ">
     <div className="absolute inset-0 z-0">
        <div
          className="absolute inset-0 backdrop-blur-sm bg-[#DEF4F433]"
          style={{
            background: "#DEF4F433",
          }}
        />
