...
const FirstSearch = () => {
  ...
  const translations = {
    ar: {
      ...
      title: `جاهزية تامة للتصدر في محركات البحث`,
      description: `متجرك مهيأ تقنياً للظهور في النتائج الأولى. بفضل البنية البرمجية المتطورة، يسهل على محركات البحث أرشفة منتجاتك، مما يضمن لك زواراً دائمين بشكل طبيعي ومجاني، ويقلل من تكاليف جلب العملاء`,
      cta: "ابدأ متجرك الآن",
      demo: "شاهد النماذج",
      stats1: "مشروع منجز",
      stats2: "دول مختلفة",
  ...
  return (
    <section className="relative flex items-center overflow-hidden py-8 md:py-12 lg:py-16">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <h2 className="text-xl text-[#025049] md:text-3xl font-bold">
            {t.badge}
          </h2>
        </motion.div> */}
        ...
        <div className="flex flex-col lg:flex-row items-stretch justify-between gap-8 md:gap-12">
          {/* Image Container */}
          <div
            className="w-full lg:w-1/2 relative flex items-center justify-center order-1"
