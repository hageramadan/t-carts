          ...
          return (
            ...
            >
              <div className="relative bg-[#4DA475] h-full w-full overflow-hidden rounded-2xl shadow-md hover:shadow-2xl transition-all duration-500 hover:-translate-y-3">
                ...
                {/* ✅ الحل: استخدم object-contain بدون padding عشان الصورة تظهر بحجمها الطبيعي في المنتصف */}
                 <div className={`relative ${index === 2 || index===0 ? 'w-4/5 h-full mx-auto' : 'w-full h-full'}`}>
                  <Image
                    src={feature.image}
                    alt={feature.title}
                    fill
                    ...
                    unoptimized={true}  // تعطيل تحسين Next.js
                  />
                </div>
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(to top, #025049CF 0%, #0F0F0F00 100%)",
                  }}
                />
